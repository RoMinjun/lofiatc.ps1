...
- **Lofi track detection:** OCR runs in the background so playback controls and channel switching remain available while a title is detected. Detection attempts time out after 30 seconds; stopping lofi or closing the session cancels the worker.
